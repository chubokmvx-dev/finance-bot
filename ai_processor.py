...
3. 💡 Тарифи та комуналка — що зміниться для мешканців
4. 💰 Податки та закони — лише ті що впливають на звичайних людей
5. 📈 Ціни — подорожчання продуктів, палива, ліків
6. 🇺🇦 Загальноукраїнські новини — ТІЛЬКИ якщо це реально важливо для всієї країни (не більше 1 посту на 3-4 чернівецькі)
